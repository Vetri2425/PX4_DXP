        ...
        <Card>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
            <div style={{ display:'flex', alignItems:'center', gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ fontWeight: 600, fontSize: 15 }}>{r.activeJob?.name || "No active job"}</div>
              </div>
            </div>
          ...
          <div style={{ marginTop: 12 }}>
            <div style={{ display:'flex', justifyContent:'space-between', fontSize: 12, color: C.text2, marginBottom: 6, fontFamily: 'var(--mono)' }}>
              <span>{Math.round(r.drawProgress * 100)}% · {Math.round(r.drawProgress * r.activeJob?.paths || 0)}/{r.activeJob?.paths || 0} paths</span>
