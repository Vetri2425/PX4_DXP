...
def _build(context, *args, **kwargs):
    ...
    for name in (
        ...
        "a_lat_max", "regulated_linear_scaling_min_speed",
        "preview_curvature_n", "xtrack_lookahead_gain", "max_linear_accel",
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("a_lat_max",                           default_value="__unset__"),
        DeclareLaunchArgument("regulated_linear_scaling_min_speed",   default_value="__unset__"),
        DeclareLaunchArgument("preview_curvature_n",                  default_value="__unset__"),
