...
SPRAY_PARAM_SCHEMA: dict[str, dict] = {
    ...
    "spray_require_rtk_fix": {
        ...
        "default": True,
        "group": "Safety",
        "description": "Require fresh, accurate RTK quality before autonomous spray",
    },
    "spray_min_fix_type": {
        "type": "int",
        "default": 6,
        "group": "Safety",
        "description": "Minimum MAVLink GPS fix type for autonomous spray (6 = RTK_FIXED)",
        "min": 5,
        "max": 6,
    },
    "gps_fix_timeout_s": {
        ...
        "default": 0.5,
        "group": "Safety",
        "description": "Maximum GPSRAW sample age before autonomous spray stops",
        "min": 0.1,
        "max": 5.0,
    },
    "spray_require_accuracy": {
        "type": "bool",
        "default": True,
        "group": "Safety",
    ...
    "spray_max_hrms_m": {
        ...
        "default": 0.10,
        "group": "Safety",
        "description": "Maximum reported horizontal accuracy for autonomous spray (m); 0 disables only the upper limit",
        "min": 0.0,
        "max": 2.0,
    },
    "gps_recover_hold_s": {
        ...
        "default": 1.0,
        "group": "Safety",
        "description": "Continuous good-RTK hold time required before spray can resume",
        "min": 0.0,
        "max": 10.0,
    },
